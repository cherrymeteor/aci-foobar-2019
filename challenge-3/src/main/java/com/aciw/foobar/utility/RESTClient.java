...
public class RESTClient {
	 ...
	 */
	public static void sendOutput(String[] dependencies) {
		try {
			// prep the client
			Client client = ClientBuilder.newClient();
			String baseUrl = retrieveUrl();
			WebTarget webTarget = client.target(baseUrl + "challenges/Dependencies/submit");
			...
			AnswerMessenger msg = new AnswerMessenger(dependencies);
