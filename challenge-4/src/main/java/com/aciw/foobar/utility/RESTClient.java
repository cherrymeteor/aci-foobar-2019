...
public class RESTClient {
	 ...
	 */
	public static void sendOutput(int[] messageCorrelation) {
		try {
			// prep the client
			Client client = ClientBuilder.newClient();
			String baseUrl = retrieveUrl();
			WebTarget webTarget = client.target(baseUrl + "challenges/MessageCorrelation/submit");
			...
			AnswerMessenger msg = new AnswerMessenger(messageCorrelation);
